...
<header class="w-full bg-transparent fixed top-0 left-0 h-28 z-50">
        <div class="container">
            <div class="bg-nav w-full absolute top-0 left-0 justify-between flex">
                <div class="flex">
                    <a href="/admin/"><img src="{{ asset('storage/properti/logo.png') }}" alt="gambar properti"
                ...
                <div class="relative text-black">
                    ...
                    id="dropdownuser">
                        <li class="my-1"><a href="/" class="hover:text-sky-600">Logout</a></li>
                    </ul>
                </div>
            </div>
            <!-- navbar start -->
                    ...
                    top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none lg:py-3 lg:w-full">
                        <ul class="block lg:flex">
                            ...
                            <li class="group relative">
                                <a href="/admin/tentang kami/" class="text-base py-2 mx-8 flex group-hover:text-sky-600
                                lg:mx-5 {{ request()->is('admin/tentang kami', 'admin/tentang kami/detail', 'admin/tentang kami/edit', 'admin/tentang kami/tambah') ? 'text-sky-600' : 'text-black' }}" id="tentangkami">Tentang Kami</a>
                                
                            </li>
                            <li class="group relative ">
                                <a href="/admin/konsultasi/" class="text-base py-2 mx-8 flex group-hover:text-sky-600
                                lg:mx-5 {{ request()->is('admin/konsultasi/', 'admin/konsultasi/detail', 'admin/konsultasi/edit', 'admin/konsultasi/tambah',
                                'admin/konsultasi/pertanyaan', 'admin/konsultasi/detail pertanyaan') ? 'text-sky-600' : 'text-black' }}" id="konsultasi">Konsultasi</a>
                                
                            </li>
                            <li class="group relative">
                                <a href="/admin/riset/" class="text-base py-2 mx-8 flex group-hover:text-sky-600
                                lg:mx-5 {{ request()->is('admin/riset', 'admin/riset/detail', 'admin/riset/edit', 'admin/riset/tambah') ? 'text-sky-600' : 'text-black' }}" id="riset">Riset</a>
                               
                            </li>
                            <li class="group relative">
                                <a href="/admin/publikasi/" class="text-base py-2 mx-8 flex group-hover:text-sky-600
                                lg:mx-6 {{ request()->is('admin/publikasi', 'admin/publikasi/detail', 'admin/publikasi/edit', 'admin/publikasi/tambah') ? 'text-sky-600' : 'text-black' }}" id="publikasi">Publikasi</a>
                            ...
                            <li class="group relative text-black ">
                                ...
                                'admin/pelatihan/edit', 'admin/pelatihan/tambah', 'admin/kegiatan', 'admin/kegiatan/detail', 'admin/kegiatan/edit', 'admin/kegiatan/tambah') ? 'text-sky-600' : 'text-black' }}" id="akademi">Akademi</a>
                                ...
                                id="dropdownakademi">
                                    <li class="my-2"><a href="/admin/pelatihan/" class="hover:text-sky-600 
                                    {{ request()->is('admin/akademi', 'admin/akademi/bercode', 'admin/akademi/detail pembayaran', 'admin/pelatihan', 'admin/pelatihan/detail',
                                    'admin/pelatihan/edit', 'admin/pelatihan/tambah') ? 'text-sky-600' : 'text-black' }}">
                                    Pelatihan
                                    </a></li>

                                    <li class="my-2"><a href="/admin/kegiatan" class="hover:text-sky-600 
                            ...
                            <li class="group relative">
                                ...
                                lg:mx-6 {{ request()->is('admin/berita',  'admin/berita/detail', 'admin/berita/edit', 'admin/berita/tambah') ? 'text-sky-600' : 'text-black' }}" id="berita">Berita</a>
                            </li>
                        </ul>
                    </nav>
                </div>
