        ...
        <div class="container max-w-full pt-2">
            <div class="grid grid-cols-4 lg:grid-cols-5 gap-3">
                <div class="mx-2 text-xs sm:text-base sm:mx-12 lg:mr-12 w-8/12">
                  ...
                  <p><a href="/admin/tentang kami/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/tentang kami/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/tentang kami/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/tentang kami/detail" class="hover:text-sky-600">Link</a></p>
                </div>
                <div class="mx-2 text-xs sm:text-base sm:mx-12 lg:mr-12 w-8/12" >
                  ...
                  <hr class="border-t-2 border-black my-1">
                  <p><a href="/admin/konsultasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/konsultasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/konsultasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/konsultasi/detail" class="hover:text-sky-600">Link</a></p>
                </div>
                <div class="mx-2 text-xs sm:text-base sm:mx-12 lg:mr-12 w-8/12">
                  ...
                  <hr class="border-t-2 border-black my-1">
                  <p><a href="/admin/riset/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/riset/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/riset/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/riset/detail" class="hover:text-sky-600">Link</a></p>
                </div>
                <div class="mx-2 text-xs sm:text-base sm:mx-12 lg:mr-12 w-8/12">
                  ...
                  <hr class="border-t-2 border-black my-1">
                  <p><a href="/admin/publikasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/publikasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/publikasi/detail" class="hover:text-sky-600">Link</a></p>
                  <p><a href="/admin/publikasi/detail" class="hover:text-sky-600">Link</a></p>
                </div>
                <div class="mx-2 text-xs sm:text-base sm:mx-12 lg:mr-12 w-8/12">
                  ...
                  <hr class="border-t-2 border-black my-1">
                  <p><a href="/admin/pelatihan" class="hover:text-sky-600">Pelatihan</a></p>
                  <p><a href="/admin/kegiatan" class="hover:text-sky-600">Kegiatan</a></p>
                </div>
