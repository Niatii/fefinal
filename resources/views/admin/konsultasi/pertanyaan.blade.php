   ...
   @include('components.headeradmin')
    ...
    <section  class="pt-36 mx-8 sm:pt-40 flex justify-center relative">
        ...
        <h1 class="ml-2 md:ml-8 font-bold text-wjudul my-4 md:text-2xl lg:text-3xl md:my-8"
            ...
            data-aos-delay="200"
            data-aos-offset="0">Pertanyaan</h1> 
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-2 py-4 border border-slate-500 text-center">
                                <a href="/admin/konsultasi/detail pertanyaan" class=" text-white p-2 sm:px-4 rounded-md bg-nav 
            ...
            <div class="my-20">
                <a href="/admin/konsultasi" class="bg-latar py-1 pr-4 pl-8 font-bold text-nav text-xs sm:text-base
                 hover:text-black focus:text-white transition duration-1000">Kembali ke konsultasi</a>
            </div>
        </div>
    </section>
