...
<body class="bg-latar text-black pb-12 min-h-screen">
   ...
   <div class="fixed left-0 top-48 z-10">
        <a href="/admin/kegiatan/detail" class="bg-nav rounded-r-md hover:bg-gradb text-xs md:text-base text-white py-2 px-4 md:px-8
            ...
            <div class="px-5 pt-20 md:px-20 w-full "
                ...
                <div class="flex flex-col justify-between py-4 leading-normal">
                    <form action="">
                        ...
                        <div>
                            <label for="judul" class="text-xs md:text-base">Judul Akademi</label> <!--edited-->
                            <input type="text" id="judul" class="text-xs md:text-base w-full border-black rounded-lg my-2" >
                        </div>
                        <div>
                            <label for="tanggal" class="text-xs md:text-base">Tanggal Akademi</label><!--edited-->
