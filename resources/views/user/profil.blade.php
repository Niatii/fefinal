            ...
            <form action="" class="sm:grid sm:grid-flow-row-dense sm:grid-cols-3">
                ...
                <div class="sm:col-span-2 sm:ms-10 grid gap-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" class="block w-full p-2 border-black rounded-md  focus:ring-blue-500 focus:border-blue-500 " placeholder="William James Moriarty" >
                    </div>
                    <div>
                        <label for="email" class="block text-xs md:text-base font-thin">
                            Email
                        </label>
                        <input type="email" id="email" class="block w-full p-2 border-black rounded-md  focus:ring-blue-500 focus:border-blue-500 " placeholder="lima@gmail.com" >
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="alamat" rows="5" class="block w-full  text-sm border border-black focus:ring-primary-500 rounded-md focus:border-primary-500 overflow-y-scroll" placeholder="cth. Jl. Ahmad Yani, Tlk. Tering, Kec. Batam Kota, Kota Batam, Kepulauan Riau 29461"></textarea>
                    </div>
