              ...
              <form class="space-y-2 md:space-y-4" action="#">
                  ...
                  <div class="flex gap-2 w-full">
                    <div>
                        ...
                        <input type="text" name="namapengguna" id="namapengguna" class="bg-gray-50 border border-gray-300 text-gray-900 md:text-xs rounded-xl focus:ring-primary-600 focus:border-primary-600 block w-full px-3 placeholder:text-xs " placeholder="Nama Pengguna" required="">
                    </div>
                    <div>
                        <label for="notelp" class="block mb-2 text-xs  text-white">No.Telp</label>
                        <input type="number" name="notelp" id="namapengguna" class="bg-gray-50 border border-gray-300 text-gray-900 md:text-xs rounded-xl focus:ring-primary-600 focus:border-primary-600 block w-full px-3 placeholder:text-xs " placeholder="No.Telp" required="">
                    </div>
